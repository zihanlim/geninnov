...
| `scoring_config` | Weighted config (drives hype + trade scores) | hype_volume_weight, hype_sentiment_weight, hype_score_threshold, edge_abstain_threshold, **edge_conviction_override** (ADR-0046), ... |
