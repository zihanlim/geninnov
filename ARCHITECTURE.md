...
flowchart TB
    ...
    subgraph BE["Backend Python Pipeline (scripts/daily_refresh.py)"]
        ...
        TG["backend/services/trade_ranker.py<br/>direction = sign(EdgeScore)<br/>(trend+regime+carry+value+sentiment,<br/>IC-weighted, abstain) size ∝ conviction<br/>carry = excess yield over funding (2-sided);<br/>None components renormalise the weights<br/>ADR-0031/0032/0033/0036"]
