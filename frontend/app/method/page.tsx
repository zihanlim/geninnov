...
//
// /method — the daily process, explained against live data.
//
  ...
  return (
    <main className="max-w-[1320px] mx-auto px-8 pt-7 pb-20">
      <header className="mb-8">
        <h1 className="text-[22px] font-semibold tracking-[-0.01em] m-0 mb-1">Method</h1>
        <p className="m-0 text-text-secondary text-[13px] max-w-[92ch]">
          ...
          attracts, and turns that into a long-short book. Every figure on this page is a live
          query against the tables the pipeline writes. Where a query returns nothing, the panel
          names the table and the reason rather than rendering a blank.
        </p>
