...
export const sectionOrder: Section[] = [
  ...
  { section: "03", title: "L1 — Theme Detection & Scoring" },
  { section: "04", title: "L1b — Narrative Tracker (Shadow)" },
  { section: "05", title: "L2 — Factor Exposure & Credit" },
  { section: "06", title: "L3 — Regime Classifier" },
  { section: "07", title: "L4 — Risk Engine" },
  { section: "08", title: "Quant Sizing Services" },
  { section: "09", title: "LLM Providers" },
  { section: "10", title: "L5 — Reasoning Agent: Reasoning / Writeup / Provenance / Ask" },
  { section: "11", title: "Supabase Tables" },
  { section: "12", title: "Frontend Surfaces" },
  { section: "13", title: "Verification" },
];
...
export interface Node {
  ...
  section?: string;
  /** Card fill override; "purple" marks an LLM-boundary node. */
  fill?: "purple";
